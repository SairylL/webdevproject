...
<style>
    ...
    <body>
        <h1>My Subjects</h1>
        <a href="forms/addform.php" class="addbtn" style="margin-left: 1080px;">Add Subject</a><br/><br/>
        <a href="forms/addsyllabusform.php" class="addbtn" style="margin-left: 1065px;" >Add Syllabuss</a><br/><br/>
        <table>
